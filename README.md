...
- JVM: 165 tests pass with 0 failures, 0 errors, and 0 skips, including compound classification/planning, fresh-telemetry replanning, all-or-none capability gates, cancellation, rollback, session/lens invalidation, one Reset, PCM trimming/silence handling, queued voice finalization/timeout, partial-result recovery, and hosted-scalar fail-closed behavior.
